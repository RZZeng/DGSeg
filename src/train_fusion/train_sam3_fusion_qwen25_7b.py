...
MLLM_JSON_FILE = os.environ.get(
    "MLLM_JSON_FILE",
    os.path.join(os.environ.get("DGSEG_ROOT", "."), "data", "refcocog_train_predictions.jsonl"),
)
...
def main():
    ...
    ckpt_dir = os.path.join("src", "train_fusion", "checkpoint_7b", script_name.replace(".", "_"))
